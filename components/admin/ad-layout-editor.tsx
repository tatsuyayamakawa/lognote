...
interface AdLayoutEditorProps {
  initialSettings: AdSettings | null;
}

export function AdLayoutEditor({ initialSettings }: AdLayoutEditorProps) {
              ...
              <div className="space-y-4">
                <Card className="border-2 border-dashed p-6">
                  ...
                  <AdSlotZone
                    ...
                    value={adSlots.in_article_pc_slot}
                    onChange={handleSlotChange}
                    height="280px"
                  />
          ...
          <div className="mx-auto max-w-md space-y-4">
            ...
            <Card className="border-2 border-dashed p-4">
              ...
              <AdSlotZone
                ...
                label="記事内広告（2つ目のH2前）"
                description="300×250 (スクエア)"
                value={adSlots.in_article_mobile_slot}
                onChange={handleSlotChange}
                height="250px"
              />
